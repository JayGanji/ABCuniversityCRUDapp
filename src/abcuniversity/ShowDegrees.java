...
public class ShowDegrees {
    ...
    public void  showMenu(){
        ...
        while (menuChoice.compareTo("Q")!=0){
            ...
            System.out.println("3 - Show All Records by degree name pattern match");
    ...
    public void menuFunction1(){
        ...
        try {
            ...
            String sql = "select * from [Degree] limit " + numRows;
 ...
 public void menuFunction2(){
     String sid;
         System.out.println("Enter the ID of the degree you want to see");
         Scanner keyboard = new Scanner(System.in);  
        ...
        try {
            String sql = "select * from [Degree] where id=" + sid +"";
 ...
 public void menuFunction3(){
         ...
         String pattern="";
         System.out.println("Enter the partial degree name that you want to match");
         Scanner keyboard = new Scanner(System.in);  
        ...
        try {
            String sql = "select * from [Degree] where Degree like '%" + pattern +"%'";
