...
public class ShowClasses {
    ...
    public void  showMenu(){
        ...
        while (menuChoice.compareTo("Q")!=0){
            ...
            System.out.println("3 - Show All Records by course name pattern match");
    ...
    public void menuFunction1(){
        ...
        try {
            ...
            String sql = "select * from [Classes] limit " + numRows;
 ...
 public void menuFunction2(){
     String sid;
         System.out.println("Enter the ID of the class you want to see");
         Scanner keyboard = new Scanner(System.in);  
        ...
        try {
            String sql = "select * from [Classes] where id=" + sid +"";
 ...
 public void menuFunction3(){
         ...
         String pattern="";
         System.out.println("Enter the partial course name that you want to match");
         Scanner keyboard = new Scanner(System.in);  
        ...
        try {
            String sql = "select * from [Classes] inner join [Courses] on Classes.CourseID=Courses.ID where CourseName like '%" + pattern +"%'";
