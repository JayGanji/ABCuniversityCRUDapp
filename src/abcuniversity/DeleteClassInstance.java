 ...
 * @author jayad
 */
public class DeleteClassInstance {
    ...
    public void  delete(){
        System.out.println("Enter the necessary information for deletion below");
         ...
         System.out.println("Enter the class instance ID for which to delete");
        ...
        try {
            ...
            String sql = "delete from Class_Instances where ID=" + iD;
            ...
            System.out.println("");
            System.out.println("ClassInstance#" + iD + " was successfully deleted.");
