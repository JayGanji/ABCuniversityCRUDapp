 ...
 * @author jayad
 */
public class InsertClassInstances {
    ...
    public void  insert(){
        System.out.println("Enter the new class instance's information below");
         String classID ="";
         String sID ="";
         String grade ="";
         ...
         System.out.println("Enter their grade received (out of 100)");
        ...
        try {
            ...
            String sql = "insert into [Class_Instances](ClassID, StudentID, GradeReceived) values ('" + classID + "', '" + sID + "', '" + grade + "')";
            ...
            System.out.println("");
            System.out.println("Class instance was successfully added.");
