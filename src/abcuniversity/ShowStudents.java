...
public class ShowStudents {
    ...
    public void  showMenu(){
        ...
        while (menuChoice.compareTo("Q")!=0){
            ...
            System.out.println("3 - Show All Records by last name pattern match");
    ...
    public void menuFunction1(){
        ...
        try {
            ...
            String sql = "select * from [Student] limit " + numRows;
 ...
 public void menuFunction3(){
        ...
        try {
            String sql = "select * from [Student] where LastName like '%" + pattern +"%'";
