...
public class DeleteMajor {
    ...
    public void  delete(){
        System.out.println("Enter the necessary information for deletion below");
         ...
         System.out.println("Enter the Major ID for which to delete");
        ...
        try {
            ...
            String sql = "delete from Majors_Offered where ID=" + iD;
            ...
            System.out.println("");
            System.out.println("Major#" + iD + " was successfully deleted.");
