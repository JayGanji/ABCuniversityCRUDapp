...
public class DeleteDegree {
    ...
    public void  delete(){
        System.out.println("Enter the necessary information for deletion below");
         ...
         System.out.println("Enter the degree ID for which to delete");
        ...
        try {
            ...
            String sql = "delete from Degrees where ID=" + iD;
            ...
            System.out.println("");
            System.out.println("Degree#" + iD + " was successfully deleted.");
