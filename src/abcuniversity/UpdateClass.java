...
public class UpdateClass {
    ...
    public void  update(){
        System.out.println("Update class information below");
         String teacherName ="";
         String cID = "";
        
         Scanner keyboard = new Scanner(System.in);  
         System.out.println("Enter the class ID for which to update");
         cID = keyboard.nextLine();
         
         
         System.out.println("Enter the new teacher's last name");
        ...
        try {
            ...
            String sql = "update Classes set ClassInstructor='" + teacherName + "' where ID=" + cID;
            ...
            System.out.println("");
            System.out.println("Class#" + cID + " was successfully updated.");
