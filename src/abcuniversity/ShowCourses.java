...
public class ShowCourses {
    ...
    public void menuFunction1(){
        ...
        try {
            ...
            String sql = "select * from [Courses] limit " + numRows;
 ...
 public void menuFunction2(){
     String sid;
         System.out.println("Enter the ID of the course you want to see");
         Scanner keyboard = new Scanner(System.in);  
        ...
        try {
            String sql = "select * from [Courses] where id=" + sid +"";
 ...
 public void menuFunction3(){
        ...
        try {
            String sql = "select * from [Courses] where CourseName like '%" + pattern +"%'";
